/obj/machinery/production/rnd/protolathe
	name = "protolathe"
...
/obj/machinery/production/rnd/protolathe/deconstruct(disassembled)
	log_game("Protolathe of type [type] [disassembled ? "disassembled" : "deconstructed"] by [key_name(usr)] at [get_area_name(src, TRUE)]")

	return ..()

/obj/machinery/production/rnd/protolathe/Initialize(mapload)
	if(!mapload)
...
/obj/machinery/production/rnd/protolathe/offstation
