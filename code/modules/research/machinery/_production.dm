...
/obj/machinery/production/rnd/update_overlays()
	. = ..()
...
/obj/machinery/production/proc/compute_efficiency()
	PROTECTED_PROC(TRUE)

/obj/machinery/production/rnd/compute_efficiency()
	var/efficiency = 1.2
...
*/
/obj/machinery/production/proc/do_make_item(datum/design/design, items_remaining, build_time_per_item, material_cost_coefficient, charge_per_item, turf/target)
	PROTECTED_PROC(TRUE)
